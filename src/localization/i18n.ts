    ...
    en: {
      translation: {
        ...
        home: {
          ...
          alchemyApiKeyTest: "Test",
          alchemyApiKeyTestSuccess: "Connected successfully ({{latency}} ms)",
          alchemyApiKeyTestError: {
            missing_key: "Enter an API key before testing.",
            unauthorized: "The API key is invalid or unauthorized.",
            rate_limited: "Alchemy rate limit reached. Try again shortly.",
            unreachable: "Could not connect to Alchemy. Check your network.",
          },
          alchemyApiKeyConfirm: "Confirm and enable",
          alchemyApiKeyCancel: "Cancel",
          alchemyApiKeyConfigured: "Configured RPC Key",
          alchemyApiKeyModify: "Modify",
    ...
    "zh-CN": {
      translation: {
        ...
        home: {
          ...
          alchemyApiKeyTest: "测试",
          alchemyApiKeyTestSuccess: "连接成功（{{latency}} 毫秒）",
          alchemyApiKeyTestError: {
            missing_key: "请先输入 API Key。",
            unauthorized: "API Key 无效或没有访问权限。",
            rate_limited: "Alchemy 请求频率已达上限，请稍后重试。",
            unreachable: "无法连接 Alchemy，请检查网络。",
          },
          alchemyApiKeyConfirm: "确认并开启",
          alchemyApiKeyCancel: "取消",
          alchemyApiKeyConfigured: "已配置 RPC Key",
          alchemyApiKeyModify: "修改",
